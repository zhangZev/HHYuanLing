...
public class Constant {
	 ...
	 * 程序运行期间产生的文件，缓存根目录
	 */
	public static final String ROOT_DIR_PATH = Environment.getExternalStorageDirectory().getAbsolutePath()
	        + "/wenbo/cache";
	 ...
	 * 本地数据库的名称
	 */
	public static final String VINORD_DB = "wenbo.db";
	 ...
	 * 头像图片文件夹
	 */
	public static final String CACHE_DIR_PATH_HEADER = CACHE_DIR_PATH_ROOT + "/headimg";

	/**
	 * web缓存
	 */
	public static final String CACHE_DIR_PATH_WEB = CACHE_DIR_PATH_ROOT + "/webcache";
