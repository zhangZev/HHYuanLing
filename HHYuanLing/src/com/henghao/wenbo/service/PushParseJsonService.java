 ...
 * 修改内容：
 */
package com.henghao.wenbo.service;
...
public class PushParseJsonService extends Service {
	...
	public void downGuideFile(AppGuideEntity appGuideEntity) {
		...
		BitmapUtils mBitmapUtils = new BitmapUtils(this, Constant.CACHE_DIR_PATH_HEADER);
		mBitmapUtils.configDefaultLoadFailedImage(R.drawable.bg_page_02);
		mBitmapUtils.configDefaultLoadingImage(R.drawable.bg_page_02);
	...
	public boolean downFile(HttpUtils http, String imageFile) {
		...
		// qin ProtocolUrl.APP_SYSTEM_IMG_URL +
		HttpHandler<File> httpHandler = http.download(imageFile, Constant.CACHE_DIR_PATH_HEADER + File.separator
