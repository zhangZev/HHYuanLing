...
import com.henghao.wenbo.activity.ScanDetailActivity;
...
public class NotPollingAdapter extends ArrayAdapter<TreeEntity> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (position > 3) {
			mHodlerView.img_tip.setImageResource(R.drawable.default_icon);
		}
		else {
			mHodlerView.img_tip.setImageResource(R.drawable.complted);
		}
