...
import com.henghao.wenbo.FMApplication;
...
public final class SysEnv {
	...
	/** 上下文 **/
	private static final Context context = FMApplication.gainContext();
	...
	/*** 本机手机号码 **/
	public static final String PHONE_NUMBER = ((TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE))
			.getLine1Number();
