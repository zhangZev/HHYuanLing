...
import com.benefit.buy.library.views.IntentSpan;

/**
 * Text TextView 处理工具〈一句话功能简述〉 〈功能详细描述〉
 * @author qinyulun
...
public class ToolsText {
     ...
     */
    public static void addUnderlineText(final Context context, final HandyTextView textView, final int start,
            final int end) {
    ...
    public static void addHyperlinks(final HandyTextView textView, final int start, final int end,
        ...
        sp.setSpan(new ForegroundColorSpan(textView.getContext().getResources().getColor(R.color.black)), start, end,
    ...
    /**
     * 获取Assets中的json文本〈一句话功能简述〉 〈功能详细描述〉
     * @param context
     * @param name 文本名称
     * @return
     * @see [类、类#方法、类#成员]
