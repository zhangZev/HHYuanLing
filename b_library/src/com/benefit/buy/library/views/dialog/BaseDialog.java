...
public class BaseDialog extends Dialog implements android.view.View.OnClickListener {
    ...
    private void initViews() {
        ...
        mBtnButton1 = (Button) findViewById(R.id.dialog_generic_btn_button_one);
        mBtnButton2 = (Button) findViewById(R.id.dialog_generic_btn_button_two);
        mBtnButton3 = (Button) findViewById(R.id.dialog_generic_btn_button_three);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.dialog_generic_btn_button_one) {
            if (mOnClickListener1 != null) {
                mOnClickListener1.onClick(mBaseDialog, 0);
            }
        }
        else if (v.getId() == R.id.dialog_generic_btn_button_two) {
            if (mOnClickListener2 != null) {
                mOnClickListener2.onClick(mBaseDialog, 1);
            }
        }
        else if (v.getId() == R.id.dialog_generic_btn_button_three) {
